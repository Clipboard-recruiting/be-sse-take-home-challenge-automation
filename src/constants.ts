...
export const PR_REVIEW_TEMPLATE_REPO = 'candidate-sse-take-home-challenge-template';
...
export const CANDITATE_PR_REVIEW_REPO_PREFIX = 'candidate-sse-take-home-challenge';
